...
```
第一步，移動到藥局。第二步，對藥劑師說 藥劑師你好，請把藥品放到我的籃子。第三步，拾取藥品。第四步，返回櫃台。第五步，對 user 說 藥品拿到了，請收好。
```
...
```json
{
    ...
    "ToBaxiaomi": {
        ...
        "Steps_Descripts": "第一步，移動到藥局。第二步，對藥劑師說 藥劑師你好，請把藥品放到我的籃子。第三步，拾取藥品。第四步，返回櫃台。第五步，對 user 說 藥品拿回來了，請服用。"
    }
}
```
